...
def create_review_prompt(content, language, custom_prompt=None):
    ...
    return (
        ...
        f"Avoid speculative comments such as 'may not be necessary' or 'may cause issues', notes about best-practice, or reminders."
        f"Only comment on definite issues or problems with the code."
        ...
        f"   ```"
        f"If the code does not contain any errors or performance issues, disregard previous formatting instructions, and reply with the exact phrase 'ignoreResponse'."
    )
